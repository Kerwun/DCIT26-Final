...
if($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	if($customer_change >= 0){
		...
		echo '<script> window.location.href="../Ordering_Application_2/index.php"</script>';
		}
	}
	else {
...
<div class="button2">
	<button   onclick="document.location='../posB_report.php'" >Check Report</button>
	</div>
<body id="bodyz">
...
<!---------------------------------3rd box-------------------------------------->			
<form role="form" method="post" action="index.php" class="a-form" enctype="multipart/form-data">
