...
$(document).ready(function() {
    $('table tbody tr').click(function(){
        ...
        window.open("admin_employee_update.php?id=" + id, "_self"); // incompletes*******************************************************
    });
});
</script>
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="" class="active"><span class="las la-handshake"></span>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                <button onclick="document.location='admin_employee_registration.php'">Create User</button>
            </div>
