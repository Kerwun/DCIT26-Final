...
if($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	if($cash_given >= 0){
		...
		echo '<script> window.location.href="admin_saleA.php"</script>';
		}
	}
	else {
...
<head>
	...
	<script src="js1/script3.js"></script>
	<!-- Main Script -->
...
<body>
    ...
    <div class="main-content">
        <header>
            <h2>
                ...
                </label> Admin Point of Sale A
            </h2>
            <div class="button2">
	<button   onclick="document.location='admin_posA_report.php'" >Check Report</button>
	</div>
	...
	<form role="form" id="form" method="post" action="admin_saleA.php" class="a-form" enctype="multipart/form-data">
...
<!-----------------------------------6th box--------------------------------------->
			...
			<fieldset class="left" id="left3">
				<table>
					<tr>
						<div class="inp">
						<td><textarea name="order_summary" id="osum" style="resize: none; width: 228px; height: 80px; margin-top: 10px;background-color: #EEEEEE; " readonly></textarea></td>
						</div>
					</tr>
					<tr>
					...
					<tr>
						<td style="position: absolute;bottom:25px; right: 90px;"><label><center></center></label></td>
					</tr>
				</table>
...
<table>
			...
			<tr>
				...
				<td><center><button class="button button5"type="button">EXIT</button></center></td>
