    ...
    <div class="main-content">
        <header>
            <h2>
                ...
                </label> Update Employee Information
            </h2>
            ...
            <div class="user-wrapper">
                ...
                <div>
                    <h4><?php echo $employee['first_name'];?> <?php echo $employee['middle_name'];?> <?php echo $employee['last_name'];?></h4>
...
<div class="col-md-10 col-md-offset-1">
  ...
  <div class="panel-body">
   <form role="form" method="post" class="a-form" id="admin_employee_update" action="admin_employee_update.php"enctype="multipart/form-data">
...
<!--------------------------------------------------------------------------------------------Address--------------------------------------------------------------------------------------->
 ...
 <!------------------------------------------------------------------------------------------Picture Path--------------------------------------------------------------------------------------->
  ...
  <div class="form-group">
                                        ...
                                        <a href="admin_employee_registration.php" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Create Here
                                        </a>
                                        </div>
