...
<head>
	...
	<link rel="stylesheet" type="text/css" href="image/style2.css">
	 <!-- jQuery library -->
...
<fieldset>
<!-----------------------------------Employee--------------------------------------->
<form role="form" method="post" name="calculate" action="Payroll.php" class="a-form" enctype="multipart/form-data">
...
<!----------------------------------Honorarium------------------------------------->	
		...
		<fieldset class="left left1" id="left2">
			<legend>HONORARIUM</legend>
				...
				<div class="input-box">
				<label for="thp">Total<br>Honorarium:</label>
		...
		<fieldset class="right" id="right2">
			<legend>OTHER DEDUCTIONS</legend>
    			...
    			<option value="phil">Philhealth</option>
  				...
  				<div class="input-box">
				<input type="number" name="others" id="others" required style="width: 315px;">
				</div>
			</div>
...
<!---------------------------------Buttons--------------------------------->
	...
	<div>
			...
			<div class="button4">
			<button class="button button4" id="but" onclick="document.location='payroll_listview.php'" >Cancel</button>
			</div>

			<div class="button5">
			<button class="button button5" id="but" name="">Print Payslip</button>
			</div>
			...
			<div class="button7">
			<button class="button button7" id="but" onclick="document.location='payroll_listview.php'"  >Exit</button>
			</div>
		</div>
