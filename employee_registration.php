...
if($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	if ($conn -> query($sql) === TRUE) {
		...
		echo '<script> window.location.href="employee_registration.php"</script>';
	}
	$conn->close();
	}
...
<div class="col-md-10 col-md-offset-1">
  ...
  <div class="panel-body">
   <form role="form" method="post" action="employee_registration.php" class="a-form" enctype="multipart/form-data">
...
<!--------------------------------------------------------------------------------------------Address--------------------------------------------------------------------------------------->
 ...
 <!------------------------------------------------------------------------------------------Picture Path--------------------------------------------------------------------------------------->
  ...
  <button class="btn btn-success" onclick="document.location='Employee_Listview.php'" >Cancel</button>
  </form>
  ...
  <div class="form-group">
                                        ...
                                        <a href="Employee_Listview.php" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Employee Listview
                                        </a>
                                        </div>
