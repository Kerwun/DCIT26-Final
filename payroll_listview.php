...
$(document).ready(function() {
	$('table tbody tr').click(function(){
		...
		window.open("Payroll.php?id=" + id, "_self"); // incompletes*******************************************************
	});
});
</script>
...
<body>
<div class="container">
	<h2 style="margin-top: 30px;margin-bottom: 20px; color: #f2f2f3;">Employee Payroll List</h2>
	<input type="text" name="search" id="search" onkeyup="myFunction()" placeholder="Search for Employee Name..." title="Type in a name">
	<div class="button2">
	...
	<div class="button">
	<center>
	<button onclick="document.location='payroll_report.php'" >Check Payroll Report</button>
</center>
	</div>
</div>
</div>
